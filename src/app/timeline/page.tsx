...
export default async function TimelinePage() {
  ...
  return (
    <div className="w-full py-10">
      {/* Header stays in the site's normal reading column... */}
      ...
      {/* ...but the axis itself deliberately breaks out of max-w-6xl: it's a
          wide horizontal scroller, so more real viewport width directly
          means less scrolling. Only relevant on desktop -- on a phone
          viewport max-w-6xl was never the constraint anyway. */}
      <div className="hidden md:block">
        <TimelineDesktop eras={eras} />
      </div>

      <div className="mx-auto w-full max-w-6xl px-4">
        <div className="mt-2 hidden flex-wrap gap-x-6 gap-y-1 text-[11px] text-neutral-600 md:flex">
