...
export default async function AdminLineagePage() {
  ...
  return (
    <div className="max-w-4xl">
      <h1 className="mb-2 text-2xl font-bold text-white">Lineage</h1>
      <p className="mb-6 max-w-2xl text-sm text-neutral-400">
        Link actors to the martial artists who trained them, and trace how far a lineage goes back. Most links
      ...
      <div className="rounded-md border border-neutral-800 bg-neutral-900 p-5">
        ...
        <p className="mb-4 text-xs text-neutral-500">
          Paste one succession chain per line, earliest first. A chain of N names becomes N&minus;1 links &mdash;
          the fast path for entering a whole lineage at once instead of one link at a time.
        </p>
        <AdminLineageBulkImport />
      </div>

      <div className="mt-6 rounded-md border border-neutral-800 bg-neutral-900 p-5">
        <h2 className="mb-1 text-base font-semibold text-white">Add a link</h2>
        <p className="mb-4 text-xs text-neutral-500">
