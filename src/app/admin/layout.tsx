...
// catalog — see AdminMoviesPage), Fight Scene Tags, Fight Styles, and
// Fight Moves, plus the same self-service Account page ADMIN gets.
...
const NAV_GROUPS: { label: string | null; links: { href: string; label: string; adminOnly: boolean }[] }[] = [
  { label: null, links: [{ href: "/admin", label: "Dashboard", adminOnly: false }] },
  {
    ...
    links: [
      ...
      { href: "/admin/fight-scene-styles", label: "Fight Styles", adminOnly: false },
      { href: "/admin/fight-scene-moves", label: "Fight Moves", adminOnly: false },
