...
- **Era quick-jump chips** sit above the axis, one per era plus a "Today →" shortcut to Contemporary; clicking one scrolls the (very wide — 3369px at full width) axis straight to that band instead of hand-scrolling past everything in between. The chip for whichever era is currently in view highlights automatically as you scroll.
