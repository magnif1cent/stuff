...
- **Sifu Lineage**: admin-curated martial arts training lineages, connecting actors already in the catalog and non-actor figures alike — a compact card on the actor page (direct sifu and students) links out to a full, multi-generation tree (see [Sifu Lineage](#sifu-lineage) below)
