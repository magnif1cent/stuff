...
- **Fight Scene Styles** (`/admin/fight-scene-styles`) and **Fight Scene Moves** (`/admin/fight-scene-moves`) &mdash; manage the two closed vocabularies behind the Style/Move data points (see [Fights](#fights) above): add, rename, delete, see usage counts. Both open to `REVIEWER`, same as Fight Scene Tags.
