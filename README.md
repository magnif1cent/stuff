...
Every profile also has an optional bio (up to 280 characters), location (up to 100 characters), and a single website/social link, all editable together from the Profile tab of your own profile and shown publicly to anyone who visits it — same visibility as the username itself. On someone else's profile these show directly under their username, above the tabs; any unset field shows nothing there, and an "Edit" control on your own Profile tab (labeled "No bio yet." when nothing's set).
